...
alias y="yab "
alias yinstall="yab module-installation-service-update tomcat-installation-service-start"
alias yelogistics="mkdir logistics-export && cd logistics-export && yab metadata-export urn:app:com.qad.logistics"
alias yeinventory="mkdir inventory-export && cd inventory-export && yab metadata-export urn:app:com.qad.inventory"
alias yequality="mkdir quality-export && cd quality-export && yab metadata-export urn:app:com.qad.quality"
alias yecosting="mkdir costing-export && cd costing-export && yab metadata-export urn:app:com.qad.costing"
alias yetranshist="mkdir transhist-export && cd transhist-export && yab metadata-export urn:app:com.qad.transhist"
alias yeqadextensions="mkdir qadextensions-export && cd qadextensions-export && yab metadata-export urn:app:com.qad.qadextensions"
...
alias dss="yab appserver-qra-memory-dump -nocompress"